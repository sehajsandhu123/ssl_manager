...
#####
ALL_SERVICES = ['HDFS', 'MRSHUFFLE', 'TEZ', 'HIVE', 'KAFKA', 'KAFKA3', 'RANGER',' RANGER_KMS', 'SPARK2', 'SPARK3','DRUID' ,'IMPALA' ,'OZONE' ,'CRUISE_CONTROL' ,'CRUISE_CONTROL3','FLINK','LIVY','LIVY3','HTTPFS','KAFKA_CONNECT','KAFKA3_CONNECT','JUPYTER','OOZIE','PINOT','CLICKHOUSE','ZOOKEEPER']
